...
If you want to create a job transfer that copies data from AWS S3 then you must have a connection configured. Information about configuration for AWS is available: `Amazon Web Service Connection <https://airflow.readthedocs.io/en/latest/howto/connection/aws.html#configuring-the-connection>`__
