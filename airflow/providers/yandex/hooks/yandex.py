...
class YandexCloudBaseHook(BaseHook):
    ...
    def monkey_patch_connection_form(form_to_patch):
        ...
        form_to_patch.extra__yandexcloud__service_account_json = PasswordField(
        ...
        form_to_patch.extra__yandexcloud__service_account_json_path = StringField(
        ...
        form_to_patch.extra__yandexcloud__public_ssh_key = StringField(
