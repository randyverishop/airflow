...
class YandexCloudBaseHook(BaseHook):
    ...
    def monkey_patch_connection_form():
        ...
        ConnectionForm.extra__yandexcloud__service_account_json = PasswordField(
        ...
        ConnectionForm.extra__yandexcloud__service_account_json_path = StringField(
        ...
        ConnectionForm.extra__yandexcloud__public_ssh_key = StringField(
