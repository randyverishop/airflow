...
class ConnectionForm(DynamicForm):
    ...
    conn_type = SelectField(
        ...
        choices=sorted(get_connection_types(), key=itemgetter(1)),  # pylint: disable=protected-access
        widget=Select2Widget(),
    )
    ...
    # You should monkey-patch connection form in the Connection via monkey_patch_connection_form method
