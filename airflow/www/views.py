...
from flask import (
    Markup, Response, current_app as flask_app, escape, flash, jsonify, make_response, redirect,
...
class Airflow(AirflowBaseView):
    ...
    def index(self):
        ...
        filter_dag_ids = flask_app.appbuilder.sm.get_accessible_dag_ids()
    ...
    def dag_stats(self, session=None):
        ...
        allowed_dag_ids = flask_app.appbuilder.sm.get_accessible_dag_ids()
    ...
    def task_stats(self, session=None):
        ...
        allowed_dag_ids = set(flask_app.appbuilder.sm.get_accessible_dag_ids())
    ...
    def refresh(self, session=None):
        ...
        dag = dagbag.get_dag(dag_id)
        # sync dag permission
        flask_app.appbuilder.sm.sync_perm_for_dag(dag_id, dag.access_control)
...
class DagFilter(BaseFilter):
    def apply(self, query, func): # noqa
        if flask_app.appbuilder.sm.has_all_dags_access():
            return query
        filter_dag_ids = flask_app.appbuilder.sm.get_accessible_dag_ids()
