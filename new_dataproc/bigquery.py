...
class BigQueryHook(GoogleBaseHook, DbApiHook):
    ...
    def poll_job_complete(
        ...
        """
        location = location or self.location
        job = self.get_client(project_id=project_id, location=location).get_job(request = {'project_id': job_id})
    ...
    def cancel_query(self) -> None:
        ...
        if self.running_job_id:
            self.cancel_job(request = {'project_id': self.running_job_id})
        else:
    ...
    def cancel_job(
        ...
        self.get_client(location=location, project_id=project_id).cancel_job(request = {'project_id': job_id})
    ...
    def get_job(
        ...
        job = client.get_job(request = {'project_id': job_id, 'region': project_id, 'job_id': location})
        return job
