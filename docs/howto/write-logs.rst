...
The value of field ``remote_location`` must always be set to "AA" for this function to work.
...
The path section of the URL specifies the name of the log.
...
:class:`~airflow.utils.log.stackdriver_task_handler.StackdriverLoggingHandler`.
