...
class TestGcpVisionHook(unittest.TestCase):
    ...
    def setUp(self):
        with mock.patch('airflow.contrib.hooks.gcp_vision_hook.CloudVisionHook.__init__',
    ...
    def test_create_productset_explicit_id(self, get_conn):
        ...
        # When
        result = hook.create_product_set(location=LOC_ID_TEST, product_set_id=PRODUCTSET_ID_TEST,
                                         product_set=product_set, project_id=PROJECT_ID_TEST, retry=None,
        ...
        create_product_set_method.assert_called_once_with(parent=parent, product_set=product_set,
                                                          product_set_id=PRODUCTSET_ID_TEST, retry=None,
                                                          timeout=None, metadata=None)
    ...
    def test_create_productset_autogenerated_id(self, get_conn):
        ...
        product_set = ProductSet()
        # When
        result = hook.create_product_set(location=LOC_ID_TEST, product_set_id=None,
                                         product_set=product_set, project_id=PROJECT_ID_TEST)
        # Then
    ...
    def test_create_productset_autogenerated_id_wrong_api_response(self, get_conn):
        ...
        with self.assertRaises(AirflowException) as cm:
            hook.create_product_set(location=LOC_ID_TEST, product_set_id=None, product_set=product_set,
                                    project_id=PROJECT_ID_TEST, retry=None, timeout=None, metadata=None)
        # Then
    ...
    def test_get_productset(self, get_conn):
        ...
        hook = self.vision_hook_default_project_id
        # When
        response = hook.get_product_set(location=LOC_ID_TEST, product_set_id=PRODUCTSET_ID_TEST,
    ...
    def test_update_productset_no_explicit_name(self, get_conn):
        ...
        hook = self.vision_hook_default_project_id
        productset_name = ProductSearchClient.product_set_path(PROJECT_ID_TEST, LOC_ID_TEST,
                                                               PRODUCTSET_ID_TEST)
        # When
        result = hook.update_product_set(location=LOC_ID_TEST, product_set_id=PRODUCTSET_ID_TEST,
                                         product_set=product_set,
                                         update_mask=None, project_id=PROJECT_ID_TEST, retry=None,
                                         timeout=None, metadata=None)
        # Then
        self.assertEqual(result, MessageToDict(product_set))
        update_product_set_method.assert_called_once_with(product_set=ProductSet(name=productset_name),
                                                          metadata=None, retry=None, timeout=None,
                                                          update_mask=None)

    @parameterized.expand([
        (None, None),
        (None, PRODUCTSET_ID_TEST),
        (LOC_ID_TEST, None)
    ])
    @mock.patch('airflow.contrib.hooks.gcp_vision_hook.CloudVisionHook.get_conn')
    def test_update_productset_no_explicit_name_and_missing_params_for_constructed_name(self, location,
                                                                                        product_set_id,
                                                                                        get_conn):
        # Given
        update_product_set_method = get_conn.return_value.update_product_set
        ...
        # When
        with self.assertRaises(AirflowException) as cm:
            hook.update_product_set(location=location, product_set_id=product_set_id,
                                    product_set=product_set,
                                    update_mask=None, project_id=PROJECT_ID_TEST, retry=None,
                                    timeout=None, metadata=None)
        err = cm.exception
        self.assertTrue(err)
        self.assertIn("Unable to determine the ProductSet name. Please either set the name directly in the "
                      "ProductSet object or provide the `location` and `productset_id` parameters.", str(err))
    ...
    @mock.patch('airflow.contrib.hooks.gcp_vision_hook.CloudVisionHook.get_conn')
    def test_update_productset_explicit_name_missing_params_for_constructed_name(self, location,
                                                                                 product_set_id, get_conn):
        # Given
        explicit_ps_name = ProductSearchClient.product_set_path(PROJECT_ID_TEST_2, LOC_ID_TEST_2,
                                                                PRODUCTSET_ID_TEST_2)
        product_set = ProductSet(name=explicit_ps_name)
        update_product_set_method = get_conn.return_value.update_product_set
        update_product_set_method.return_value = product_set
        hook = self.vision_hook_default_project_id
        # When
        result = hook.update_product_set(location=location, product_set_id=product_set_id,
                                         product_set=product_set,
                                         update_mask=None, project_id=PROJECT_ID_TEST, retry=None,
                                         timeout=None, metadata=None)
        # Then
        self.assertEqual(result, MessageToDict(product_set))
        update_product_set_method.assert_called_once_with(product_set=ProductSet(name=explicit_ps_name),
                                                          metadata=None, retry=None, timeout=None,
                                                          update_mask=None)
    ...
    def test_update_productset_explicit_name_different_from_constructed(self, get_conn):
        ...
        explicit_ps_name = ProductSearchClient.product_set_path(PROJECT_ID_TEST_2, LOC_ID_TEST_2,
                                                                PRODUCTSET_ID_TEST_2)
        product_set = ProductSet(name=explicit_ps_name)
        template_ps_name = ProductSearchClient.product_set_path(PROJECT_ID_TEST, LOC_ID_TEST,
                                                                PRODUCTSET_ID_TEST)
        # When
        ...
        with self.assertRaises(AirflowException) as cm:
            hook.update_product_set(location=LOC_ID_TEST, product_set_id=PRODUCTSET_ID_TEST,
                                    product_set=product_set,
                                    update_mask=None, project_id=PROJECT_ID_TEST, retry=None,
                                    timeout=None, metadata=None)
        err = cm.exception
        ...
        self.assertTrue(err)
        self.assertIn("The ProductSet name provided in the object ({}) is different than the name "
    ...
    def test_delete_productset(self, get_conn):
        ...
        hook = self.vision_hook_default_project_id
        # When
        response = hook.delete_product_set(location=LOC_ID_TEST, product_set_id=PRODUCTSET_ID_TEST,
                                           project_id=PROJECT_ID_TEST)
        # Then
    ...
    def test_create_product_explicit_id(self, get_conn):
        ...
        product = Product()
        # When
        result = hook.create_product(location=LOC_ID_TEST, product_id=PRODUCT_ID_TEST, product=product,
                                     project_id=PROJECT_ID_TEST)
        # Then
        ...
        create_product_method.assert_called_once_with(parent=parent, product=product,
                                                      product_id=PRODUCT_ID_TEST, retry=None, timeout=None,
                                                      metadata=None)
    ...
    def test_create_product_autogenerated_id(self, get_conn):
        ...
        product = Product()
        # When
        result = hook.create_product(location=LOC_ID_TEST, product_id=None, product=product,
                                     project_id=PROJECT_ID_TEST)
        # Then
    ...
    def test_create_product_autogenerated_id_wrong_name_in_response(self, get_conn):
        ...
        # When
        with self.assertRaises(AirflowException) as cm:
            hook.create_product(location=LOC_ID_TEST, product_id=None, product=product,
                                project_id=PROJECT_ID_TEST)
        # Then
    ...
    def test_update_product_no_explicit_name(self, get_conn):
        ...
        # When
        result = hook.update_product(location=LOC_ID_TEST, product_id=PRODUCT_ID_TEST, product=product,
                                     update_mask=None, project_id=PROJECT_ID_TEST, retry=None, timeout=None,
                                     metadata=None)
        # Then
        self.assertEqual(result, MessageToDict(product))
        update_product_method.assert_called_once_with(product=Product(name=product_name),
                                                      metadata=None, retry=None, timeout=None,
                                                      update_mask=None)

    @parameterized.expand([
        (None, None),
        (None, PRODUCT_ID_TEST),
        (LOC_ID_TEST, None)
    ])
    @mock.patch('airflow.contrib.hooks.gcp_vision_hook.CloudVisionHook.get_conn')
    def test_update_product_no_explicit_name_and_missing_params_for_constructed_name(self, location,
                                                                                     product_id,
                                                                                     get_conn):
        # Given
        update_product_method = get_conn.return_value.update_product
        ...
        # When
        with self.assertRaises(AirflowException) as cm:
            hook.update_product(location=location, product_id=product_id, product=product, update_mask=None,
                                project_id=PROJECT_ID_TEST, retry=None, timeout=None, metadata=None)
        err = cm.exception
        self.assertTrue(err)
        self.assertIn("Unable to determine the Product name. Please either set the name directly in the "
                      "Product object or provide the `location` and `product_id` parameters.", str(err))
    ...
    @mock.patch('airflow.contrib.hooks.gcp_vision_hook.CloudVisionHook.get_conn')
    def test_update_product_explicit_name_missing_params_for_constructed_name(self, location, product_id,
                                                                              get_conn):
        # Given
        explicit_p_name = ProductSearchClient.product_path(PROJECT_ID_TEST_2, LOC_ID_TEST_2,
                                                           PRODUCT_ID_TEST_2)
        ...
        hook = self.vision_hook_default_project_id
        # When
        result = hook.update_product(location=location, product_id=product_id, product=product,
                                     update_mask=None, project_id=PROJECT_ID_TEST, retry=None, timeout=None,
                                     metadata=None)
        # Then
        self.assertEqual(result, MessageToDict(product))
        update_product_method.assert_called_once_with(product=Product(name=explicit_p_name), metadata=None,
                                                      retry=None, timeout=None, update_mask=None)
    ...
    def test_update_product_explicit_name_different_from_constructed(self, get_conn):
        ...
        # Should throw AirflowException in this case.
        with self.assertRaises(AirflowException) as cm:
            hook.update_product(location=LOC_ID_TEST, product_id=PRODUCT_ID_TEST, product=product,
                                update_mask=None, project_id=PROJECT_ID_TEST, retry=None, timeout=None,
                                metadata=None)
        err = cm.exception
        self.assertTrue(err)
        self.assertIn("The Product name provided in the object ({}) is different than the name "
                      "created from the input parameters ({}). Please either: 1) Remove the Product "
                      "name, 2) Remove the location and product_id parameters, 3) Unify the "
    ...
    def test_delete_product(self, get_conn):
        ...
        hook = self.vision_hook_default_project_id
        # When
        response = hook.delete_product(location=LOC_ID_TEST, product_id=PRODUCT_ID_TEST,
                                       project_id=PROJECT_ID_TEST)
        # Then
        self.assertIsNone(response)
