...
class CloudVisionProductSetCreateTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        mock_hook.return_value.create_product_set.assert_called_once_with(
            ...
            product_set_id=None, project_id=None, retry=None, timeout=None, metadata=None
        )
    ...
    def test_already_exists(self, _handle_request, get_conn):
        ...
        op = CloudVisionProductSetCreateOperator(location=LOCATION_TEST, product_set=PRODUCTSET_TEST,
                                                 product_set_id=PRODUCTSET_ID_TEST,
                                                 project_id='mock-project-id', task_id='id')
...
class CloudVisionProductSetUpdateTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        op = CloudVisionProductSetUpdateOperator(location=LOCATION_TEST,
                                                 product_set=PRODUCTSET_TEST,
                                                 task_id='id')
        op.execute(context=None)
        mock_hook.assert_called_once_with(gcp_conn_id=GCP_CONN_ID)
        mock_hook.return_value.update_product_set.assert_called_once_with(
            location=LOCATION_TEST, product_set=PRODUCTSET_TEST,
            product_set_id=None, project_id=None, retry=None, timeout=None, metadata=None, update_mask=None
        )
...
class CloudVisionProductSetGetTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        op = CloudVisionProductSetGetOperator(location=LOCATION_TEST,
                                              product_set_id=PRODUCTSET_ID_TEST,
                                              task_id='id')
        op.execute(context=None)
        mock_hook.assert_called_once_with(gcp_conn_id=GCP_CONN_ID)
        mock_hook.return_value.get_product_set.assert_called_once_with(
            location=LOCATION_TEST, product_set_id=PRODUCTSET_ID_TEST,
...
class CloudVisionProductSetDeleteTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        op = CloudVisionProductSetDeleteOperator(location=LOCATION_TEST, product_set_id=PRODUCTSET_ID_TEST,
                                                 task_id='id')
        op.execute(context=None)
        mock_hook.assert_called_once_with(gcp_conn_id=GCP_CONN_ID)
...
class CloudVisionProductCreateTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        op = CloudVisionProductCreateOperator(location=LOCATION_TEST, product=PRODUCT_TEST,
                                              task_id='id')
        op.execute(context=None)
        mock_hook.assert_called_once_with(gcp_conn_id=GCP_CONN_ID)
        mock_hook.return_value.create_product.assert_called_once_with(
            location=LOCATION_TEST, product=PRODUCT_TEST,
            product_id=None, project_id=None, retry=None, timeout=None, metadata=None
        )
    ...
    def test_already_exists(self, _handle_request, get_conn):
        ...
        # Exception AlreadyExists not raised, caught in the operator's execute() - idempotence
        op = CloudVisionProductCreateOperator(location=LOCATION_TEST, product=PRODUCT_TEST,
                                              product_id=PRODUCT_ID_TEST, project_id='mock-project-id',
                                              task_id='id')
        result = op.execute(None)
...
class CloudVisionProductGetTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        mock_hook.return_value.get_product.assert_called_once_with(
            location=LOCATION_TEST, product_id=PRODUCT_ID_TEST,
            project_id=None, retry=None, timeout=None, metadata=None
        )
...
class CloudVisionProductUpdateTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        mock_hook.return_value.update_product.assert_called_once_with(
            location=LOCATION_TEST, product=PRODUCT_TEST,
            product_id=None, project_id=None, retry=None, timeout=None, metadata=None, update_mask=None
        )
...
class CloudVisionProductDeleteTest(unittest.TestCase):
    ...
    def test_minimal_green_path(self, mock_hook):
        ...
        op = CloudVisionProductDeleteOperator(location=LOCATION_TEST, product_id=PRODUCT_ID_TEST,
                                              task_id='id')
        op.execute(context=None)
        mock_hook.assert_called_once_with(gcp_conn_id=GCP_CONN_ID)
